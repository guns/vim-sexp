...
let s:sexp_default_mappings = {
    ...
    \ 'sexp_element_wrap_square_head':    '<Leader><M-[>',
    \ 'sexp_element_wrap_square_tail':    '<Leader><M-]>',
    \ 'sexp_element_wrap_curly_head':     '<Leader><M-{>',
    \ 'sexp_element_wrap_curly_tail':     '<Leader><M-}>',
